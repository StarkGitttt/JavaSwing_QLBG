 ...
 * @author DELL
 */
public class HoaDonCTCancelForm extends javax.swing.JDialog {
    DefaultTableModel tblModel;
    HoaDonCTDAO hdCTDAO ;
    List<Object[]> lstObj, lstInfor;
    public HoaDonCTCancelForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void fillTable(int idInvoice) {
        ...
        lstObj = hdCTDAO.getInvoiceCancel(idInvoice);
        if(lstObj.size() > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoaDonCTCancelForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HoaDonCTCancelForm dialog = new HoaDonCTCancelForm(new javax.swing.JFrame(), true);
