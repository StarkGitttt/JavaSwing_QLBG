 ...
 * @author DELL
 */
public class DragAndDropProduct implements DropTargetListener {
    JLabel imageLabel = new JLabel();
    JLabel pathLabel = new JLabel();
    JLabel hiddenStr = new JLabel();
    public DragAndDropProduct(JLabel image, JLabel hidden) {
        imageLabel = image;
        hiddenStr = hidden;
    }
    @Override
    ...
    public void displayImage(String path) {
        ...
        XImg.saveDADImgProduct(path, imageLabel.getToolTipText());
        hiddenStr.setVisible(false);
    }
}
